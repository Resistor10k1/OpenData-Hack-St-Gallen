...
path = "data/einzugsgebiet-der-primar-und-sekundarschulen-stgallen.csv"
df_school = pd.read_csv(path, sep=';', usecols=['Geo Point', 'Bezeichnun', 'Stufe'])
...
fig = px.scatter_mapbox(df_school, lat='latitude', lon='longitude',
                  ...
                  size_max=15, zoom=10, mapbox_style="carto-positron", text='Bezeichnun')
